...
var app = (function () {
    ...
    */
    ...
    function create_if_block_3(ctx) {
    	let h3;
    	let t1;
    	let t2_value = /*files*/ ctx[0][0].name + "";
    	let t2;
    	let t3;
    	let button;
    	let mounted;
    	...
    	const block = {
    		c: function create() {
    			h3 = element("h3");
    			h3.textContent = "Selected file:";
    			t1 = space();
    			t2 = text(t2_value);
    			t3 = space();
    			button = element("button");
    			button.textContent = "Confirm and process";
    			add_location(h3, file, 234, 4, 7888);
    			add_location(button, file, 236, 4, 7938);
    		},
    		...
    		p: function update(ctx, dirty) {
    			if (dirty & /*files*/ 1 && t2_value !== (t2_value = /*files*/ ctx[0][0].name + "")) set_data_dev(t2, t2_value);
    		},
    ...
    function create_if_block_2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			h3 = element("h3");
    			h3.textContent = "Input data";
    			t1 = space();
    			div = element("div");
    			t2 = space();
    			button = element("button");
    			button.textContent = "Trim excess header and trailing rows from this table";
    			add_location(h3, file, 247, 4, 8201);
    			attr_dev(div, "id", "step-1-data");
    			attr_dev(div, "class", "big-html-table svelte-1phzss2");
    			add_location(div, file, 248, 4, 8226);
    			add_location(button, file, 251, 4, 8325);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, h3, anchor);
    			insert_dev(target, t1, anchor);
    			insert_dev(target, div, anchor);
    			div.innerHTML = /*parsed_original_HTML*/ ctx[11];
    			insert_dev(target, t2, anchor);
    			insert_dev(target, button, anchor);

    			if (!mounted) {
    				dispose = listen_dev(button, "click", /*click_handler_1*/ ctx[22], false, false, false, false);
    				mounted = true;
    			}
    		},
    		p: function update(ctx, dirty) {
    			if (dirty & /*parsed_original_HTML*/ 2048) div.innerHTML = /*parsed_original_HTML*/ ctx[11];		},
    		d: function destroy(detaching) {
    			if (detaching) detach_dev(h3);
    			if (detaching) detach_dev(t1);
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(247:2) {#if parsed_original_HTML}",
    		ctx
    	});
    ...
    function create_if_block_1(ctx) {
    	...
    	let mounted;
    	let dispose;
    	let each_value = /*detected_index_columns*/ ctx[8][0];
    	...
    	const block = {
    		c: function create() {
    			h3 = element("h3");
    			h3.textContent = "Trimmed data";
    			t1 = space();
    			p0 = element("p");
    			t2 = text(/*trimmed_header_rows_count*/ ctx[13]);
    			t3 = text(" excess row(s) were removed the top of the sheet,\r\n      and ");
    			t4 = text(/*trimmed_trailing_rows_count*/ ctx[12]);
    			t5 = text(" row(s) were removed from the bottom. The\r\n      trimmed table now looks like this:");
    			t6 = space();
    			div = element("div");
    			t7 = space();
    			p1 = element("p");
    			p1.textContent = "The next step will pivot the table, such that there is only one row for\r\n      each unique combination of index columns. (A.k.a, a \"tall table.\") From\r\n      this data, the detected index columns are:";
    			t9 = space();
    			ul0 = element("ul");
    			...
    			t10 = space();
    			p2 = element("p");
    			p2.textContent = "The rest of the columns in each row will be collapsed into two values,\r\n      called:";
    			t12 = space();
    			ul1 = element("ul");
    			li0 = element("li");
    			b0 = element("b");
    			b0.textContent = `${POST_PIVOT_LABELS_COLUMN_NAME}`;
    			t14 = text(", with the ");
    			i0 = element("i");
    			i0.textContent = "name";
    			t16 = text(" from each other\r\n        column.");
    			t17 = space();
    			li1 = element("li");
    			b1 = element("b");
    			b1.textContent = `${POST_PIVOT_VALUES_COLUMN_NAME}`;
    			t19 = text(", with the ");
    			i1 = element("i");
    			i1.textContent = "value";
    			t21 = text(" in that column\r\n        from the given row.");
    			t22 = space();
    			button = element("button");
    			button.textContent = "Pivot this data using these indices";
    			add_location(h3, file, 264, 4, 8797);
    			add_location(p0, file, 265, 4, 8824);
    			attr_dev(div, "id", "step-2-data");
    			attr_dev(div, "class", "big-html-table svelte-1phzss2");
    			add_location(div, file, 270, 4, 9051);
    			add_location(p1, file, 273, 4, 9156);
    			add_location(ul0, file, 278, 4, 9383);
    			add_location(p2, file, 283, 4, 9521);
    			add_location(b0, file, 289, 8, 9659);
    			add_location(i0, file, 289, 57, 9708);
    			add_location(li0, file, 288, 6, 9645);
    			add_location(b1, file, 293, 8, 9787);
    			add_location(i1, file, 293, 57, 9836);
    			add_location(li1, file, 292, 6, 9773);
    			add_location(ul1, file, 287, 4, 9633);
    			add_location(button, file, 297, 4, 9922);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, h3, anchor);
    			insert_dev(target, t1, anchor);
    			...
    			insert_dev(target, div, anchor);
    			div.innerHTML = /*trimmed_data_as_HTML_table*/ ctx[10];
    			...
    			if (!mounted) {
    				dispose = listen_dev(button, "click", /*click_handler_2*/ ctx[23], false, false, false, false);
    				mounted = true;
    			}
    		},
    		p: function update(ctx, dirty) {
    			if (dirty & /*trimmed_header_rows_count*/ 8192) set_data_dev(t2, /*trimmed_header_rows_count*/ ctx[13]);
    			if (dirty & /*trimmed_trailing_rows_count*/ 4096) set_data_dev(t4, /*trimmed_trailing_rows_count*/ ctx[12]);
    			if (dirty & /*trimmed_data_as_HTML_table*/ 1024) div.innerHTML = /*trimmed_data_as_HTML_table*/ ctx[10];
    			if (dirty & /*detected_index_columns*/ 256) {
    				each_value = /*detected_index_columns*/ ctx[8][0];
    				validate_each_argument(each_value);
    				let i;
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(264:2) {#if trimmed_array.length}",
    		ctx
    	});
    ...
    // (280:6) {#each detected_index_columns[0] as index_column_label}
    function create_each_block(ctx) {
    	let li;
    	let t_value = /*index_column_label*/ ctx[28] + "";
    	let t;
    	...
    	const block = {
    		c: function create() {
    			li = element("li");
    			t = text(t_value);
    			add_location(li, file, 280, 8, 9460);
    		},
    		m: function mount(target, anchor) {
    		...
    		p: function update(ctx, dirty) {
    			if (dirty & /*detected_index_columns*/ 256 && t_value !== (t_value = /*index_column_label*/ ctx[28] + "")) set_data_dev(t, t_value);
    		},
    		d: function destroy(detaching) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(280:6) {#each detected_index_columns[0] as index_column_label}",
    		ctx
    	});
    ...
    function create_if_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			h3 = element("h3");
    			h3.textContent = "Pivoted tall data";
    			t1 = space();
    			p0 = element("p");
    			p0.textContent = "Here is the reshaped data in the \"tall\" format.";
    			t3 = space();
    			div = element("div");
    			t4 = space();
    			p1 = element("p");
    			p1.textContent = "And that's it! This data is now ready to be uploaded to the destination of\r\n      your choosing.";
    			add_location(h3, file, 313, 4, 10402);
    			add_location(p0, file, 314, 4, 10434);
    			attr_dev(div, "id", "step-3-data");
    			attr_dev(div, "class", "big-html-table svelte-1phzss2");
    			add_location(div, file, 315, 4, 10494);
    			add_location(p1, file, 318, 4, 10596);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, h3, anchor);
    			insert_dev(target, t1, anchor);
    			...
    			insert_dev(target, t3, anchor);
    			insert_dev(target, div, anchor);
    			div.innerHTML = /*tall_data_as_HTML_table*/ ctx[9];
    			insert_dev(target, t4, anchor);
    			insert_dev(target, p1, anchor);
    		},
    		p: function update(ctx, dirty) {
    			if (dirty & /*tall_data_as_HTML_table*/ 512) div.innerHTML = /*tall_data_as_HTML_table*/ ctx[9];		},
    		d: function destroy(detaching) {
    			if (detaching) detach_dev(h3);
    			if (detaching) detach_dev(t1);
    			if (detaching) detach_dev(p0);
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(313:2) {#if tall_array.length}",
    		ctx
    	});
    ...
    function create_fragment(ctx) {
    	...
    	let mounted;
    	let dispose;
    	let if_block0 = /*files*/ ctx[0] && create_if_block_3(ctx);
    	let if_block1 = /*parsed_original_HTML*/ ctx[11] && create_if_block_2(ctx);
    	let if_block2 = /*trimmed_array*/ ctx[2].length && create_if_block_1(ctx);
    	let if_block3 = /*tall_array*/ ctx[5].length && create_if_block(ctx);
    	...
    	const block = {
    		c: function create() {
    			...
    			div = element("div");
    			h1 = element("h1");
    			h1.textContent = "Excel Parser";
    			t2 = space();
    			p0 = element("p");
    			p0.textContent = "Upload an Excel file to this tab to see it quickly transformed into an HTML\r\n    object.";
    			t4 = space();
    			p1 = element("p");
    			p1.textContent = "Then, step-by-step cleaning functions will help transform it to a clean,\r\n    tall table, accounting for some common cases along the way.";
    			t6 = space();
    			label = element("label");
    			label.textContent = "Select an data file to process:";
    			t8 = space();
    			input = element("input");
    			t9 = space();
    			...
    			document.title = "Excel Parser";
    			attr_dev(meta, "name", "excel-parser");
    			attr_dev(meta, "content", "Transform Excel Files");
    			add_location(meta, file, 207, 2, 7154);
    			add_location(h1, file, 211, 2, 7263);
    			add_location(p0, file, 213, 2, 7290);
    			add_location(p1, file, 218, 2, 7401);
    			attr_dev(label, "for", "file_picker");
    			add_location(label, file, 223, 2, 7561);
    			attr_dev(input, "type", "file");
    			attr_dev(input, "id", "file_picker");
    			attr_dev(input, "name", "file_picker");
    			...
    			add_location(input, file, 224, 2, 7630);
    			attr_dev(div, "class", "text-column");
    			add_location(div, file, 210, 0, 7234);
    		},
    		...
    		p: function update(ctx, [dirty]) {
    			...
    			if (/*parsed_original_HTML*/ ctx[11]) {
    				if (if_block1) {
    ...
    function count_columns(dataframe) {
    	return dataframe.reduce((maxLen, el, i, arr) => el.length > maxLen ? el.length : maxLen, 0);
    }
    ...
    function instance($$self, $$props, $$invalidate) {
    	let trimmed_header_rows_count;
    	let trimmed_trailing_rows_count;
    	let active_sheet;
    	let parsed_original_HTML;
    	let trimmed_data_as_HTML_table;
    	let tall_data_as_HTML_table;
    	...
    	function parseExcelFile(my_file) {
    		...
    		reader.onload = e => {
    			...
    			$$invalidate(1, workbook = readSync(data));
    	...
    	function trimHeaderRows(dataframe) {
    		...
    		return [
    			/*remaining:*/
    			df.slice(first_true_row_index, df.length),
    			/*removed:*/
    			df.slice(0, first_true_row_index)
    		];
    	}
    	...
    	function getIndexColumns(dataframe) {
    		...
    		return [matched_raw_values, matched_col_indices, matched_standardized_values];
    	}

    	function getNonIndexCoumns(dataframe) {
    		let [index_column_labels, index_column_indices, _] = getIndexColumns(dataframe);
    		let header_row = dataframe[0];
    		...
    		let matched_col_indices = dataframe_column_indices.filter(i => !index_column_indices.includes(i));
    	...
    	function trimTrailingRows(dataframe) {
    		...
    		for (let i = dataframe.length - 1; i >= 0; i--) {
    			...
    			let detected_index_values = detected_index_columns[1].map(x => dataframe[i][x]);
    		...
    		let output = [
    			/*remaining:*/
    			dataframe.slice(0, last_true_row_index + 1),
    			/*removed:*/
    			dataframe.slice(last_true_row_index + 1, dataframe.length)
    		];
    	...
    	function pivot_to_tall(dataframe, new_index_column_label = "column", new_value_column_label = "value") {
    		...
    		let [index_columns_labels, index_column_indices, _] = getIndexColumns(dataframe);

    		let [value_columns_labels, value_column_indices] = getNonIndexCoumns(dataframe);

    		// We have to populate the first row with the column labels we want in the final product...
    		let output = [[...index_columns_labels, new_index_column_label, new_value_column_label]];
    		...
    		for (let i = 1; i < dataframe.length; i++) {
    			...
    			value_column_indices.forEach((element, index) => {
    				output.push([...row_index_values, value_columns_labels[index], row_contents[element]]);
    			});
    		}
    	...
    	const click_handler_1 = () => {
    		$$invalidate(2, [trimmed_array, trimmed_header_rows] = trimHeaderRows(active_sheet), trimmed_array, $$invalidate(3, trimmed_header_rows));

    		//trimmed_header_row_count = trimmed_header_rows.length
    		$$invalidate(8, detected_index_columns = getIndexColumns(trimmed_array));

    		$$invalidate(2, [trimmed_array, trimmed_trailing_rows] = trimTrailingRows(trimmed_array), trimmed_array, $$invalidate(4, trimmed_trailing_rows));
    	};

    	const click_handler_2 = () => {
    		$$invalidate(5, tall_array = pivot_to_tall(trimmed_array, POST_PIVOT_LABELS_COLUMN_NAME, POST_PIVOT_VALUES_COLUMN_NAME));
    	...
    	$$self.$capture_state = () => ({
    		...
    		trimmed_array,
    		trimmed_header_rows,
    		trimmed_trailing_rows,
    		tall_array,
    		COMPLETE_COLUMNS_RATIO,
    		DATE_COLUMN_MAPPINGS,
    		POST_PIVOT_LABELS_COLUMN_NAME,
    		POST_PIVOT_VALUES_COLUMN_NAME,
    		CUSTOM_INDEX_COLUMN_MAPPINGS,
    		ALL_INDEX_COLUMN_MAPPINGS,
    		...
    		get_fake_columns,
    		pivot_to_tall,
    		tall_data_as_HTML_table,
    		trimmed_data_as_HTML_table,
    		active_sheet,
    		parsed_original_HTML,
    		trimmed_trailing_rows_count,
    		trimmed_header_rows_count
    	});

    	$$self.$inject_state = $$props => {
    		if ('files' in $$props) $$invalidate(0, files = $$props.files);
    		if ('fileInput' in $$props) $$invalidate(7, fileInput = $$props.fileInput);
    		if ('workbook' in $$props) $$invalidate(1, workbook = $$props.workbook);
    		if ('trimmed_array' in $$props) $$invalidate(2, trimmed_array = $$props.trimmed_array);
    		if ('trimmed_header_rows' in $$props) $$invalidate(3, trimmed_header_rows = $$props.trimmed_header_rows);
    		if ('trimmed_trailing_rows' in $$props) $$invalidate(4, trimmed_trailing_rows = $$props.trimmed_trailing_rows);
    		if ('tall_array' in $$props) $$invalidate(5, tall_array = $$props.tall_array);
    		if ('detected_index_columns' in $$props) $$invalidate(8, detected_index_columns = $$props.detected_index_columns);
    		if ('tall_data_as_HTML_table' in $$props) $$invalidate(9, tall_data_as_HTML_table = $$props.tall_data_as_HTML_table);
    		if ('trimmed_data_as_HTML_table' in $$props) $$invalidate(10, trimmed_data_as_HTML_table = $$props.trimmed_data_as_HTML_table);
    		if ('active_sheet' in $$props) $$invalidate(6, active_sheet = $$props.active_sheet);
    		if ('parsed_original_HTML' in $$props) $$invalidate(11, parsed_original_HTML = $$props.parsed_original_HTML);
    		if ('trimmed_trailing_rows_count' in $$props) $$invalidate(12, trimmed_trailing_rows_count = $$props.trimmed_trailing_rows_count);
    		if ('trimmed_header_rows_count' in $$props) $$invalidate(13, trimmed_header_rows_count = $$props.trimmed_header_rows_count);
    	};
    	...
    	$$self.$$.update = () => {
    		if ($$self.$$.dirty & /*trimmed_header_rows*/ 8) {
    			$$invalidate(13, trimmed_header_rows_count = trimmed_header_rows.length);
    		}

    		if ($$self.$$.dirty & /*trimmed_trailing_rows*/ 16) {
    			$$invalidate(12, trimmed_trailing_rows_count = trimmed_trailing_rows.length);
    		}
    		...
    		if ($$self.$$.dirty & /*workbook*/ 2) {
    			$$invalidate(6, active_sheet = workbook
    			? workbook.Sheets[workbook.SheetNames[0]]
    			: null);
    		}

    		if ($$self.$$.dirty & /*active_sheet*/ 64) {
    			$$invalidate(11, parsed_original_HTML = active_sheet ? utils.sheet_to_html(active_sheet) : null);
    		}

    		if ($$self.$$.dirty & /*trimmed_array*/ 4) {
    			$$invalidate(10, trimmed_data_as_HTML_table = trimmed_array.length
    			? utils.sheet_to_html(utils.aoa_to_sheet(trimmed_array))
    			: null);
    		}

    		if ($$self.$$.dirty & /*tall_array*/ 32) {
    			$$invalidate(9, tall_data_as_HTML_table = tall_array.length
